...
Porque proporciona un identificador único en cada elemento de una lista. De manera tal que el sistema pueda dirigirse exactamente hacia donde sea necesario y no existan erroreres de no haberlo encontrado o haber borrado algo erroneamente.
---
